...
SUPPORT_CHANNEL = getenv(
    "SUPPORT_CHANNEL", "https://t.me/QrupBotlari"
)  # Example:- https://t.me/TheTeamVivek
SUPPORT_GROUP = getenv(
    "SUPPORT_GROUP", "https://t.me/QrupBotlariDestek"
...
GITHUB_REPO = getenv("GITHUB_REPO", "https://t.me/QrupBotlari")
...
START_IMG_URL = getenv(
    "START_IMG_URL",
    "https://files.catbox.moe/c7cywa.jpg",
)

PING_IMG_URL = getenv(
    "PING_IMG_URL",
    "https://files.catbox.moe/x8azsc.jpg",
)
...
if PING_IMG_URL:
    if PING_IMG_URL != "https://files.catbox.moe/x8azsc.jpg":
...
if PLAYLIST_IMG_URL:
    if PLAYLIST_IMG_URL != "https://files.catbox.moe/x8azsc.jpg":
...
if GLOBAL_IMG_URL:
    if GLOBAL_IMG_URL != "https://files.catbox.moe/x8azsc.jpg":
...
if STATS_IMG_URL:
    if STATS_IMG_URL != "https://files.catbox.moe/x8azsc.jpg":
...
if TELEGRAM_AUDIO_URL:
    if TELEGRAM_AUDIO_URL != "https://files.catbox.moe/x8azsc.jpg":
...
if STREAM_IMG_URL:
    if STREAM_IMG_URL != "https://files.catbox.moe/x8azsc.jpg":
...
if SOUNCLOUD_IMG_URL:
    if SOUNCLOUD_IMG_URL != "https://files.catbox.moe/x8azsc.jpg":
...
if YOUTUBE_IMG_URL:
    if YOUTUBE_IMG_URL != "https://files.catbox.moe/x8azsc.jpg":
...
if TELEGRAM_VIDEO_URL:
    if TELEGRAM_VIDEO_URL != "https://files.catbox.moe/x8azsc.jpg":
